...
AProjectile::AProjectile()
{
	...
	TrailParticleSystemComponent = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("Trail Particle System"));
	...
	FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if(MyOwner == nullptr || OtherActor == MyOwner)
	{
		Destroy();
		return;
	}
	...
	//Use static class if we dont care about the type of damage type
	UClass* const DamageType = UDamageType::StaticClass();
